...
public class ExpandableMissileAdapter extends BaseExpandableListAdapter {
    ...
    private ArrayList<ArrayList<Missile>> children;
    
    public ExpandableMissileAdapter(Context context, ArrayList<String> groups,
            ArrayList<ArrayList<Missile>> children) {
    ...
    public void addItem(Missile s) {
        ...
        if (children.size() < index + 1) {
            children.add(new ArrayList<Missile>());
        }
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild,
        ...
        Missile s = (Missile) getChild(groupPosition, childPosition);
        View v = convertView;
        if (v == null) {
    ...
    private void sort(ArrayList<Missile> a){
    
    	//Collections.sort(a, new Comparator<Missile>() {

			//public int compare(Missile object1, Missile object2) {
