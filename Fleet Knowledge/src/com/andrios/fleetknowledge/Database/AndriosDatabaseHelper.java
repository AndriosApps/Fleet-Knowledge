...
public class AndriosDatabaseHelper extends SQLiteOpenHelper{
	...
	private static final String SHIPS_CREATE = "create table ships (_id integer primary key autoincrement, type text not null, ship_class text not null, dimensions text not null, crew text not null, weapons text not null, performance text not null, propulsion text not null, aircraft text not null, ew text not null, sensors text not null, boats text not null, about text not null, image text not null);";
	private static final String SUBS_CREATE = "create table subs (_id integer primary key autoincrement, type text not null, sub_class text not null, dimensions text not null, crew text not null, weapons text not null, performance text not null, propulsion text not null, aircraft text not null, ew text not null, sensors text not null, boats text not null, about text not null, image text not null);";
